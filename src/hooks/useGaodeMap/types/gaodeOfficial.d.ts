...
declare global {
  ...
  namespace AMap {
    ...
    export class CoreDistrictLayer extends TileLayer {}
     ...
     * @private
     */
    export class LabelsLayer_1 extends Layer {
      CLASS_NAME: string;
     ...
     * map.add(labelsLayer);
     */
    export class LabelsLayer extends LabelsLayer_1 {
      constructor(opts?: LabelsLayerOptions);
      /**
       * 获取标注层是否支持内部标注避让
       * @name getCollision
    ...
    export class CoreVectorLayer extends Layer {}
     ...
     * layer.add(circle);
     */
    class VectorLayer extends CoreVectorLayer {
      /**
